...
<body>
	<%
		...
		ItemDTO item = dao.selectOne(Integer.parseInt(request.getParameter("itemNo")));
	%>
						...
						<div class="row">
							<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
								<div class="single_product_thumbnails">
									<ul>
										<li class="active"><img src="<%=item.getImage()%>"
											alt="" data-image="<%=item.getImage()%>"></li>
									</ul>
								</div>
							</div>
					...
					<div class="product_details">
						...
						<div
							...
							<div class="quantity_selector">
								<form method="post" action="addCart.jsp" id="cartForm">
									<input type="hidden" id="userNo" name="userNo"
										value="<%if(session.getAttribute("user")!=null){ %><%=((UserDTO) session.getAttribute("user")).getUserNo()%><%} %>" />
									<input type="hidden" name="itemNo"
										value="<%=item.getItemNo()%>" /> <input type="hidden"
										id="quantity" name="quantity" value="" /> <span class="minus"><i
										class="fa fa-minus" aria-hidden="true"></i></span> <span
										id="quantity_value">1</span> <span class="plus"><i
					...
					<div class="col">
						<div class="tabs_container">
							<ul
								...
								<li class="tab active" data-active-tab="tab_2"><span>Additional
										Information</span></li>
	...
	<script type="text/javascript">
		$(".add_to_cart_button").on('click', (function() {
			if ($("#userNo").val() == "") {
				...
				$("#quantity").val($("#quantity_value").text());
				var form = $("#cartForm");
				form.submit();
			}
		}));
